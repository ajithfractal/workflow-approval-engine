...
/**
 * Guard to ensure a work item is in SUBMITTED status before allowing START_REVIEW transition.
 */
public class WorkItemSubmittedGuard implements Guard<WorkItemStatus, WorkItemEvent> {
    ...
    public boolean evaluate(StateContext<WorkItemStatus, WorkItemEvent> context) {
        ...
        return workItem.getStatus() == WorkItemStatus.SUBMITTED;
    }
}
