...
/**
 * Guard to ensure a work item is in IN_REVIEW status before allowing APPROVE/REJECT/SEND_TO_REWORK transitions.
 */
public class WorkItemInReviewGuard implements Guard<WorkItemStatus, WorkItemEvent> {
    ...
    public boolean evaluate(StateContext<WorkItemStatus, WorkItemEvent> context) {
        ...
        return workItem.getStatus() == WorkItemStatus.IN_REVIEW;
    }
}
