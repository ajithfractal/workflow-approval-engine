...
/**
 * Guard to ensure a work item is in DRAFT status before allowing SUBMIT transition.
 */
public class WorkItemDraftGuard implements Guard<WorkItemStatus, WorkItemEvent> {
    ...
    public boolean evaluate(StateContext<WorkItemStatus, WorkItemEvent> context) {
        ...
        return workItem.getStatus() == WorkItemStatus.DRAFT;
    }
}
